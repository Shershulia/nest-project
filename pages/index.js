      ...
      <FrontendLayout>
        <div className="text-center w-5/12 flex flex-col py-16 px-5">
          ...
          <h2 className="text-base py-3 leading-9">
            Welcome to NEST! Established in 1998, we're a vibrant community of
            Nepalese students and alumni in Trondheim. Join us and experience
            the essence of Nepal in Norway!
          </h2>
        </div>
