...
const AdminNavBar = ({showNav,setShowNav}) => {
  ...
  return (
      <>
        <div
          className={
            `flex-col w-full md:w-1/4 text-center items-center justify-between 
            gap-4 min-h-screen text-white ${showNav? "flex" : "hidden"} md:flex`
          }
        >
